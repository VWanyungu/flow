...
//             <input onChange={(e) => setForm({...form, playlistUrl: e.target.value})} type="text" className="w-full bg-orange-400 border-2 border-black text-xl py-2 px-4 cursor-text" placeholder="Paste your playlist here" id="playlistUrl" />
...
//               <p className={`font-bold text-white rounded-full ${status.fetchPlaylist ? "bg-orange-400" : "bg-gray-300"} flex items-center justify-center p-2 text-sm`}>01</p>
...
//             <div className="flex flex-col items-center w-96">
//               <p className={`font-bold text-white rounded-full bg-gray-300 ${status.optimizingComplete ? "bg-orange-400" : "bg-gray-300"} flex items-center justify-center p-2 text-sm`}>02</p>
...
//             <div className="flex flex-col items-center w-96">
//               <p className={`font-bold text-white rounded-full bg-gray-300 ${status.playlistCreated ? "bg-orange-400" : "bg-gray-300"} flex items-center justify-center p-2 text-sm`}>03</p>
...
// async function request(data: unknown, endpoint: string) {
      ...
      >
        <div>
          ...
          <h3 className="font-['Space_Grotesk'] font-bold text-3xl mt-1">
            {playlistInfo?.name ?? "Your new playlist"}
          </h3>
        </div>
        <a
